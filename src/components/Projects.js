  ...
  <section className="content-section" id="projects">
    ...
    <div className="project-item">
      <div className="projects-logo-name">
        <a
          href="https://suduoku.vercel.app/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img
            src={process.env.PUBLIC_URL + "/suduoku-logo.ico"}
            alt="Suduoku Logo"
            className="suduoku-logo"
          />
        </a>
        <h3>Suduoku</h3>
      </div>
      ...
      <ul>
        ...
        <li>
          UX features include chat, player position tracking, candidates and
          solution validation
        </li>
      </ul>
